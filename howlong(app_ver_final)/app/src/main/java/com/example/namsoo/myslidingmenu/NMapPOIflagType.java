...
public class NMapPOIflagType {
	...
	//내맘대로
	public static final int REDJAM= SPOT+3;
	public static final int YELLOWJAM=SPOT+1;
	public static final int GREENJAM = SPOT+2;
	public static final int BLACKJAM = SPOT+4;
